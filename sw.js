 ...
 */
const CACHE = 'propertech-v64'; // 22/07/2026: par do index PCF_V64 (correções de envio: visit_id estável, dead-letter, painel da fila, envio por máquina) + V63 assinaturas; bump junto com cada deploy
