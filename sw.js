 ...
 */
const CACHE = 'propertech-v72'; // 31/07/2026: par do index PCF_V72 — UX de campo (caixa de instruções removida, MODO OS no banco de máquinas — dentro de uma OS o banner deixa de oferecer máquina de outro cliente, barreira de confirmação Inspeção×Preventiva nos 2 sentidos, seta ▸ da peça voltou a fechar e a caixa de PRAZO saiu de trás dela, foto salva no aparelho por download direto com aviso na tela) + MOTOR DE PDF (as assinaturas não sobrepõem mais as fotos — com nº ÍMPAR de fotos a seção 7 não avançava a última linha; coleta e desenho separados para o PCM V100 gerar o MESMO relatório; assinaturas passam a ser persistidas como anexo 'assinatura'). SEM mudança de GAS (roda com v79 ou v80). Anteriores: PCF_V71 (coleta do técnico deixa de ser apagada na reentrada da tarefa), PCF_V70 (checklist de PISTÃO por calendário + acabamento de campo). Bump junto com cada deploy
